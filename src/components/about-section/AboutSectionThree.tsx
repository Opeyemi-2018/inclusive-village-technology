    ...
    return (
        <div className="lg:px-10 px-3">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 py-32 mb-2">
                ...
                <h1 className="flex-1 lg:text-7xl text-5xl font-unbounded uppercase font-bold max-w-2xl">
            ...
            <div className="grid grid-cols-1   lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-100 p-6  rounded-2xl flex flex-col justify-between h-[350px]">
                    <div className='flex flex-col  md:gap-20 gap-16'>
                        <div className='flex items-center md:text-5xl text-4xl font-unbounded  font-bold'>
                            <h3 className="  mb-2">200</h3>
                            <span className='text-orange-600'>+</span>
                        </div>
                        <div className='space-y-4'>
                            <h4 className="text-md:3xl text-2xl font-bold font-unbounded uppercase mb-3">Successful Projects</h4>
