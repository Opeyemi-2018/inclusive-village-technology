...
const AboutSectionOne = () => {
    return (
        <div className="lg:px-10 px-3 py-40">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 pt-20">
                ...
                <div className="w-full lg:w-auto max-w-md space-y-10">
                    ...
                    <p className="text-gray-700">
                        At PixelHive, we aren&apos;t simply a virtual organization — we&apos;re a collective of inventive troubleshooters who trust in the potential of mindful virtual answers to revolutionize businesses.
                    </p>
                    <LinkWithArrow
                        href="/contact"
                        label="get in touch"
